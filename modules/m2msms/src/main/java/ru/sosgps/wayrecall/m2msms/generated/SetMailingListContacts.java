 ...
 *         &lt;element name="contacts" type="{http://mcommunicator.ru/M2M}ArrayOfMailingListContact" minOccurs="0"/&gt;
...
@XmlRootElement(name = "SetMailingListContacts")
public class SetMailingListContacts {

    protected long mailingListId;
    protected ArrayOfMailingListContact contacts;
     ...
     *     
     */
    public ArrayOfMailingListContact getContacts() {
        return contacts;
    }
     ...
     *     
     */
    public void setContacts(ArrayOfMailingListContact value) {
        this.contacts = value;
    }
