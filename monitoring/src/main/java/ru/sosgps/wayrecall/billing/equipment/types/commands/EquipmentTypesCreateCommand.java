...
public class EquipmentTypesCreateCommand  implements Serializable, CommandEntityInfo{
 @TargetAggregateIdentifier
    ...
    public EquipmentTypesCreateCommand(ObjectId eqTypeId,Map<String, Object> data) {
