...
public class TariffPlanCreateEvent implements Serializable,WayrecallAxonEvent {
private final ObjectId tariffId;
    ...
    public TariffPlanCreateEvent(ObjectId tariffId, HashMap<String, Object> data) {
    ...
    public Map<String, Object> toHRTable() {
      ...
      //  StringBuilder sb = new StringBuilder();
        ...
        for (final Map.Entry<String, Object> item : eventdata.entrySet()) {
            String tkey = WayrecallAggregateTranslate.TariffPlanTranslate().getOrElse(item.getKey(), new AbstractFunction0<String>() {
                @Override
                public String apply() {
                    return item.getKey();
                };
