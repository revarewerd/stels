...
public class PermissionCreateEvent extends AbstractPermissionEvent  implements Serializable,WayrecallAxonEvent {
    ...
    public PermissionCreateEvent(ObjectId permissionId, HashMap<String, Object> data) {
